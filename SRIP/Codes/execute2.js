...
function initExecute() {
    if (status == 0) {
        ...
        for (var i = DataSegIndex + 1; i < TextSegIndex; i++) {
            ...
            VariablesName[TempName]=parseInt(TempValue);
...
function setTheIntialArea() {
    ...
    for (var i = TextSegIndex + 1; i < ProgLines.length; i++) {
        var TempStr = ProgLines[i];
          const label = labelMatcher.exec(TempStr);
            if (label !== null && label !== undefined) {
                jumpTable[label[1]] = ProgramAddrLengthCount;
            }
...
function stepUtil() {
    ...
    if (page == "execute.html") {
        ...
        if (StepCounter < ProgramAddrLengthCount && status >= 1) {
            if (StepCounter > 0) {
                if(prev!=1){
    document.getElementById(("code").concat((StepCounter - prev-1).toString())).parentElement.style = "background-color:white";
   
                }
                else{
                document.getElementById(("code").concat((StepCounter - prev).toString())).parentElement.style = "background-color:white";
            }
            }
    ...
    if (TextSegmentCode[index] === ProcessingCode) {
        ...
        switch (TempOpcode) {
            ...
            case "addi":
                ...
                var IndexTemp = newstr[2].indexOf("");
                var reg3 = newstr[2].slice(IndexTemp);

                var NodeReg1 = document.getElementById(reg1);
                var NodeReg2 = document.getElementById(reg2);
                //reg1=reg2+reg3
                alert(parseInt((NodeReg2.innerHTML), 10));
                alert(parseInt(reg3, 10));
                NodeReg1.innerHTML = parseInt((NodeReg2.innerHTML), 10) + parseInt(reg3, 10);
                NodeReg1.parentElement.style = "background-color:grey";
                PreviousId = reg1;
                break;
            case "addiu":
                ...
                var NodeReg2 = document.getElementById(reg2);
                //reg1=reg2+reg3
                NodeReg1.innerHTML = (parseInt((NodeReg2.innerHTML), 10)<<16>>16) + parseInt(reg3, 10);
                NodeReg1.parentElement.style = "background-color:grey";
                PreviousId = reg1;
                break;
            case "addu":
            ...
            case "andi":
                ...
                var NodeReg2 = document.getElementById(reg2);
                //reg1=reg2+reg3
                NodeReg1.innerHTML = (parseInt((NodeReg2.innerHTML), 10)) & (parseInt(reg3, 10)& 0x0000FFFF);
                NodeReg1.parentElement.style = "background-color:grey";
                PreviousId = reg1;
                break;
            case "b":
                var newstr = ProcessingCode.split(" ");
                var IndexTemp = newstr[1].indexOf("");
                var reg3 = newstr[1].slice(IndexTemp);
                return jumpTable[reg3];
                break;
            case "beq":
                var newstr = ProcessingCode.split(",");
                var reg1 = newstr[0].slice(TempIndex + 1);
                ...
                if(parseInt((NodeReg1.innerHTML), 10) == parseInt((NodeReg2.innerHTML), 10)){
                NodeReg1.parentElement.style = "background-color:grey";
                PreviousId = reg1;
                return jumpTable[reg3];
            ...
            case "beqz":
                ...
                if(parseInt((NodeReg1.innerHTML), 10) == 0){
                NodeReg1.parentElement.style = "background-color:grey";
                PreviousId = reg1;
                        return jumpTable[reg3];
            ...
            case "bgezal":
                ...
                NodeReg1.parentElement.style = "background-color:grey";
                PreviousId = reg1;
                var PcNode = document.getElementById("ra");
            PcNode.innerHTML = pc+4;
            PcNode.parentElement.style = "background-color:grey";
                        return jumpTable[reg3];
            ...
            case "div":
                ...
                NodeReg1.parentElement.style = "background-color:grey";
                PreviousId = reg1;
 var PcNode = document.getElementById("hi");
            PcNode.innerHTML = parseInt((NodeReg2.innerHTML), 10) % parseInt((NodeReg3.innerHTML), 10);
            PcNode.parentElement.style = "background-color:grey";
var PcNode = document.getElementById("lo");
            PcNode.innerHTML = parseInt((NodeReg2.innerHTML), 10) / parseInt((NodeReg3.innerHTML), 10);
            PcNode.parentElement.style = "background-color:grey";
                break;
            case "j":
            ...
            case "sw":
                ...
                var IndexTemp = newstr[1].indexOf("");
                var reg2 = newstr[1].slice(IndexTemp);

                var NodeReg1 = document.getElementById(reg1);
                 VariablesName[reg2]=NodeReg1.innerHTML;
                NodeReg1.parentElement.style = "background-color:grey";
                PreviousId = reg1;
                break;
            default:
